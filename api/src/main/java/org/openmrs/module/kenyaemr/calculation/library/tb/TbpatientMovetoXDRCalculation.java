...
public class TbpatientMovetoXDRCalculation extends
...
Concept movetoXDRoutcomresult = Dictionary.getConcept(Dictionary.MOVE_TO_XDR);
CalculationResultMap ret = new CalculationResultMap();
CalculationResultMap lastoutcomeClassiffication = Calculations.lastObs(
		tboutcome, cohort, context);
for (Integer ptId : cohort) {
	boolean onmovetoXDROutcome = false;
