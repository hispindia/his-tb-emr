...
public class MDRTBtotalPatient24MnthReportBuilder extends AbstractReportBuilder{
	...
	protected List<Mapped<DataSetDefinition>> buildDataSets(ReportDescriptor descriptor, ReportDefinition report) {
		return Arrays.asList(
				...
				ReportUtils.map(createTbOtherCategorywitheitherpaspatientwithXpertORconventionalDst(), "startDate=${startDate},endDate=${endDate}"),
	...
	private DataSetDefinition createTbsmearpositiveculturepositivewithEitherpaspatientwithXpertORconventionalDst() {
		...
		dsd.setName("A");
		dsd.setDescription("Outcome of patient treated with MDR TB standard regimen either with or without  PAS  and with smear positive and Solid OR Liquidculture positive at iniatiation withXpertORconventionalDst");
	...
	private DataSetDefinition createTbCategoryIIFwithEitherpaspatientwithXpertORconventionalDst() {
		...
		EmrReportingUtils.addRow(dsd, "CA1", "No. of detected cases with Treatment After Failure(IR or RR) with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITBwitheitherpas(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "CB1", "No. of detected cases with Treatment After Failure(IR or RR) with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITBwitheitherpas(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "CC1", "No. of detected cases with Treatment After Failure(IR or RR)  with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITBwitheitherpas(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "CD1", "No. of detected cases with Treatment After Failure(IR or RR)  with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITBwitheitherpas(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "CE1", "No. of detected cases with Treatment After Failure(IR or RR)  with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITBwitheitherpas(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "CF1", "No. of detected cases with Treatment After Failure(IR or RR)  with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITBwitheitherpas(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "CG1", "No. of detected cases with Treatment After Failure(IR or RR)  with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITBwitheitherpas(), indParams), columnsG);
		return  dsd;
	}
	...
	private DataSetDefinition createTbCategoryIITADwithEitherpaspatientwithXpertORconventionalDst() {
		...
		EmrReportingUtils.addRow(dsd, "DA1", "No. of detected cases with Treatment after Loss to follow up(IR or RR) with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.confirmedDefaultTBwitheitherpas(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "DB1", "No. of detected cases with Treatment after Loss to follow up(IR or RR) with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.confirmedDefaultTBwitheitherpas(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "DC1", "No. of detected cases with Treatment after Loss to follow up(IR or RR)  with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.confirmedDefaultTBwitheitherpas(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "DD1", "No. of detected cases with Treatment after Loss to follow up(IR or RR)  with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.confirmedDefaultTBwitheitherpas(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "DE1", "No. of detected cases with Treatment after Loss to follow up(IR or RR)  with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.confirmedDefaultTBwitheitherpas(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "DF1", "No. of detected cases with Treatment after Loss to follow up(IR or RR)  with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedDefaultTBwitheitherpas(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "DG1", "No. of detected cases with Treatment after Loss to follow up(IR or RR)  with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.confirmedDefaultTBwitheitherpas(), indParams), columnsG);
		return  dsd;
	}
	...
	private DataSetDefinition createTbRelapseCategoryIIwithEitherpaspatientwithXpertORconventionalDst() {
		...
		EmrReportingUtils.addRow(dsd, "EA1", "No. of detected cases with Relapse (IR or RR)  with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.confirmedTBwitheitherpas(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "EB1", "No. of detected cases with Relapse (IR or RR)  with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.confirmedTBwitheitherpas(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "EC1", "No. of detected cases with Relapse (IR or RR)  with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.confirmedTBwitheitherpas(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "ED1", "No. of detected cases with Relapse (IR or RR)  with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.confirmedTBwitheitherpas(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "EE1", "No. of detected cases with Relapse (IR or RR)  with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.confirmedTBwitheitherpas(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "EF1", "No. of detected cases with Relapse (IR or RR)  with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedTBwitheitherpas(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "EG1", "No. of detected cases with Relapse (IR or RR) with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.confirmedTBwitheitherpas(), indParams), columnsG);
		return  dsd;
	}
	...
	private DataSetDefinition createTbCategoryIFwithEitherpaspatientwithXpertORconventionalDst() {
		...
		EmrReportingUtils.addRow(dsd, "FA1", "No. of detected cases with Non converter (IR or RR)  with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.confirmedCatITBwitheitherpas(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "FB1", "No. of detected cases with Non converter (IR or RR) with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.confirmedCatITBwitheitherpas(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "FC1", "No. of detected cases with Non converter (IR or RR)  with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.confirmedCatITBwitheitherpas(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "FD1", "No. of detected cases with Non converter (IR or RR) with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.confirmedCatITBwitheitherpas(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "FE1", "No. of detected cases with Non converter (IR or RR) with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.confirmedCatITBwitheitherpas(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "FF1", "No. of detected cases with Non converter (IR or RR) with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedCatITBwitheitherpas(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "FG1", "No. of detected cases with Non converter (IR or RR) with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.confirmedCatITBwitheitherpas(), indParams), columnsG);
		return  dsd;
	}
	...
	private DataSetDefinition createTbOtherCategorywitheitherpaspatientwithXpertORconventionalDst() {
		CohortIndicatorDataSetDefinition dsd = new CohortIndicatorDataSetDefinition();
		dsd.setName("I");
		...
		EmrReportingUtils.addRow(dsd, "IA1", "No. of detected cases with Other Category cases  with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.confirmedotherCategoryMDRTBwitheitherpas(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "IB1", "No. of detected cases with Other Category cases with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.confirmedotherCategoryMDRTBwitheitherpas(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "IC1", "No. of detected cases with Other Category cases  with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.confirmedotherCategoryMDRTBwitheitherpas(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "ID1", "No. of detected cases with Other Category with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.confirmedotherCategoryMDRTBwitheitherpas(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "IE1", "No. of detected cases with Other Category cases with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.confirmedotherCategoryMDRTBwitheitherpas(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "IF1", "No. of detected cases with Other Category cases with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedotherCategoryMDRTBwitheitherpas(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "IG1", "No. of detected cases with Other Category cases with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.confirmedotherCategoryMDRTBwitheitherpas(), indParams), columnsG);
		return  dsd;
	}
	private DataSetDefinition createTbsmearpositiveculturepositivewithEitherpaspatientwithTBEnrollNumber() {
		...
		EmrReportingUtils.addRow(dsd, "JA1", "No. of detected cases with smear (+)ve and Culture (+) with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.Tbsmearculturewithpas(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "JB1", "No. of detected cases new with smear (+)ve and Culture (+) with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.Tbsmearculturewithpas(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "JC1", "No. of detected cases new with smear (+)ve and Culture (+) with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.Tbsmearculturewithpas(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "JD1", "No. of detected cases new with smear (+)ve and Culture (+) with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.Tbsmearculturewithpas(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "JE1", "No. of detected cases new with smear (+)ve and Culture (+) with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.Tbsmearculturewithpas(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "JF1", "No. of detected cases new with smear (+)ve and Culture (+) with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.Tbsmearculturewithpas(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "JG1", "No. of detected cases new with smear (+)ve and Culture (+) with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.Tbsmearculturewithpas(), indParams), columnsG);
		return  dsd;
	}
	private DataSetDefinition createTbsmearnegativeculturpositiveewithEitherpaspatientwithTBEnrollNumber() {
		CohortIndicatorDataSetDefinition dsd = new CohortIndicatorDataSetDefinition();
		dsd.setName("K");
		dsd.setDescription("Outcome of patient treated with MDR TB standard regimen either with or without PAS  and with smear negative and Solid OR Liquid culture  positive at iniatiation withTBEnrollNumber from Enrollment Form");
		dsd.addParameter(new Parameter("startDate", "Start Date", Date.class));
		dsd.addParameter(new Parameter("endDate", "End Date", Date.class));
		dsd.addDimension("parameter",map(commonDimensions.treatmentOutcome()));
		dsd.addDimension("patienttype",map(commonDimensions.typeOfPatients()));
		...
		EmrReportingUtils.addRow(dsd, "KA1", "No. of detected cases with smear (-)ve and Culture (+) with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.Tbsmearnegativeculturewithpas(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "KB1", "No. of detected cases new with smear (-)ve and Culture (+) with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.Tbsmearnegativeculturewithpas(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "KC1", "No. of detected cases new with smear (-)ve and Culture (+) with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.Tbsmearnegativeculturewithpas(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "KD1", "No. of detected cases new with smear (-)ve and Culture (+) with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.Tbsmearnegativeculturewithpas(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "KE1", "No. of detected cases new with smear (-)ve and Culture (+) with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.Tbsmearnegativeculturewithpas(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "KF1", "No. of detected cases new with smear (-)ve and Culture (+) with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.Tbsmearnegativeculturewithpas(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "KG1", "No. of detected cases new with smear (-)ve and Culture (+) with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.Tbsmearnegativeculturewithpas(), indParams), columnsG);
		return  dsd;
	}
	private DataSetDefinition createTbCategoryIIFwithEitherpaspatientwithTBEnrollNumber() {
		...
		EmrReportingUtils.addRow(dsd, "MF1", "No. of detected cases with Treatment after failure of treatment (IR , RR)  with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITBwitheitherpas(), indParams), columnsF);
	...
	private DataSetDefinition createTbCategoryIITADwithEitherpaspatientwithTBEnrollNumber() {
		...
		EmrReportingUtils.addRow(dsd, "NF1", "No. of detected cases with Treatment after lost to follow up (IR , RR)  with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedDefaultTBwitheitherpas(), indParams), columnsF);
	...
	private DataSetDefinition createTbRelapseCategoryIIwithEitherpaspatientwithTBEnrollNumber() {
		...
		EmrReportingUtils.addRow(dsd, "OF1", "No. of detected cases with Relapse ( IR, RR)  with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedTBwitheitherpas(), indParams), columnsF);
	...
	private DataSetDefinition createTbCategoryIFwithEitherpaspatientwithTBEnrollNumber() {
		...
		EmrReportingUtils.addRow(dsd, "PF1", "No. of detected cases with Non-Converter (IR , RR) with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedCatITBwitheitherpas(), indParams), columnsF);
	...
	private DataSetDefinition createTbMDRTBCASESwithEitherpaspatientwithTBEnrollNumber() {
		...
		EmrReportingUtils.addRow(dsd, "QF1", "No. of detected cases with MDR tb cases with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedstandardMDRTBwitheitherpas(), indParams), columnsF);
	...
	private DataSetDefinition createTbOtherCategorywitheitherpaspatientwithTBEnrollNumber() {
		...
		EmrReportingUtils.addRow(dsd, "RF1", "No. of detected cases with Other Category cases with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedotherCategoryMDRTBwitheitherpas(), indParams), columnsF);
