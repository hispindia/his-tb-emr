...
public class MDRTBwithoutPASReportBuilder extends AbstractReportBuilder{
	...
	private DataSetDefinition createTbNewCategorywithoutpaspatientwithXpertORconventionalDst() {
		...
		EmrReportingUtils.addRow(dsd, "GA1", "No. of detected cases with NEW patient tb cases  with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "GB1", "No. of detected cases with NEW patient tb cases with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "GC1", "No. of detected cases with NEW patient  tb cases  with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "GD1", "No. of detected cases with NEW patient tb cases with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "GE1", "No. of detected cases with NEW patient tb cases with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "GF1", "No. of detected cases with NEW patient tb cases with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "GG1", "No. of detected cases with NEW patient tb cases with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsG);
		return  dsd;
	}
	private DataSetDefinition createTbMDRTBCASESwithoutpaspatientwithXpertORconventionalDst() {
		...
		EmrReportingUtils.addRow(dsd, "HA1", "No. of detected cases with MDR tb cases  with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.confirmedstandardMDRTB(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "HB1", "No. of detected cases with MDR tb cases with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.confirmedstandardMDRTB(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "HC1", "No. of detected cases with MDR tb cases  with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.confirmedstandardMDRTB(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "HD1", "No. of detected cases with MDR tb cases with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.confirmedstandardMDRTB(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "HE1", "No. of detected cases with MDR tb cases with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.confirmedstandardMDRTB(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "HF1", "No. of detected cases with MDR tb cases with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedstandardMDRTB(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "HG1", "No. of detected cases with MDR tb cases with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.confirmedstandardMDRTB(), indParams), columnsG);
		return  dsd;
	}
	...
	private DataSetDefinition createTbNewCategorywithoutpaspatientwithTBEnrollNumber() {
		...
		EmrReportingUtils.addRow(dsd, "KA1", "No. of detected cases with New category with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "KB1", "No. of detected cases with New category with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "KC1", "No. of detected cases with New category  with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "KD1", "No. of detected cases with New category with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "KE1", "No. of detected cases with New category  with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "KF1", "No. of detected cases with New category  with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "KG1", "No. of detected cases with New category  with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.confirmednewCategoryMDRTB(), indParams), columnsG);
		return  dsd;
	}
	...
	private DataSetDefinition createTbCategoryIIFwithoutpaspatientwithTBEnrollNumber() {
		...
		EmrReportingUtils.addRow(dsd, "LA1", "No. of detected cases with CAT II F with outcome (Cure) ", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITB(), indParams), columnsA);
		EmrReportingUtils.addRow(dsd, "LB1", "No. of detected cases with CAT II F with outcome (Died) ", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITB(), indParams), columnsB);
		EmrReportingUtils.addRow(dsd, "LC1", "No. of detected cases with CAT II F  with outcome (Completed)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITB(), indParams), columnsC);
		EmrReportingUtils.addRow(dsd, "LD1", "No. of detected cases with CAT II F  with outcome (Failure)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITB(), indParams), columnsD);
		EmrReportingUtils.addRow(dsd, "LE1", "No. of detected cases with CAT II F  with outcome (Defaulted)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITB(), indParams), columnsE);
		EmrReportingUtils.addRow(dsd, "LF1", "No. of detected cases with CAT II F  with outcome (TransferedOut)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITB(), indParams), columnsF);
		EmrReportingUtils.addRow(dsd, "LG1", "No. of detected cases with CAT II F  with outcome (Still Enroll)", ReportUtils.map(tbIndicatorLibrary.confirmedCatIITB(), indParams), columnsG);
		return  dsd;
	}
